...
public class Block {
	...
	public virtual Vector2[] FaceUVs (Direction direction)
	{
		...
		UVs [0] = new Vector2 (tileSize * tilePos.x + tileSize - tileSize/textureInset, tileSize * tilePos.y + tileSize/textureInset);
		UVs [1] = new Vector2 (tileSize * tilePos.x + tileSize - tileSize/textureInset, tileSize * tilePos.y + tileSize -  tileSize/textureInset);
		UVs [2] = new Vector2 (tileSize * tilePos.x + tileSize/textureInset, tileSize * tilePos.y + tileSize - tileSize/textureInset);
		UVs [3] = new Vector2 (tileSize * tilePos.x + tileSize/textureInset, tileSize * tilePos.y + tileSize/textureInset);
	...
	public void setPathToIcon(string path) {
		pathToIcon = path;
	}
